...
response.meta.author = 'Clint P. George <cgeorge@cise.ufl.edu>'
response.meta.description = 'The Topic Visualization Project'
response.meta.keywords = 'Latent Dirichlet Allocation, Topic Modeling, Text Mining'
...
if DEVELOPMENT_MENU and auth.user_id in [3]: _() # restricts to user_id = 3
